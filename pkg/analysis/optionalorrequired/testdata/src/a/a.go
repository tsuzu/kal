...
type OptionalOrRequiredTestStruct struct {
	...
	MarkedOptionalAndKubeBuilderOptional string // want "field MarkedOptionalAndKubeBuilderOptional should use marker optional instead of kubebuilder:validation:Optional"

	// +required
	// +kubebuilder:validation:Required
	MarkedRequiredAndKubeBuilderRequired string // want "field MarkedRequiredAndKubeBuilderRequired should use marker required instead of kubebuilder:validation:Required"
